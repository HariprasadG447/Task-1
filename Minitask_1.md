...
## 1) [Finger print based Security System](https://www.projectsof8051.com/fingerprint-based-security-system/#:~:text=Fingerprint%20based%20security%20system%20is,give%20the%20impression%20of%20fingerprint.) 
...
## 2) [Sun Tracking Solar Panel](https://www.electronicshub.org/sun-tracking-solar-panel/)
...
## 3) [Human Detection Robot](https://www.electronicshub.org/human-detection-robot/)
...
## 4) [Automatic Room light Controller](https://ijret.org/volumes/2016v05/i04/IJRET20160504014.pdf)
...
## 5) [Wireless Stethoscope](https://circuitdigest.com/microcontroller-projects/diy-wireless-digital-stethoscope)
...
## 6) [Portable Weather Station](https://www.electronicwings.com/users/abhijit1698/projects/33/portable-weather-station)
...
## 7) [Raspberry Pi Internet Radio and Streaming Station](https://circuitdigest.com/microcontroller-projects/raspberry-pi-internet-radio-and-streaming-station)
